...
echo "create fulltext index text_index on searchtable (text);" | /usr/bin/mysql -uroot -pmysql ntg
echo "create fulltext index word_index on word (word);" | /usr/bin/mysql -uroot -pmysql ntg
